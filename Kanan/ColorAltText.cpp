...
namespace kanan {
	...
	void ColorAltText::onPatchUI() {
		...
		if (m_isEnabledOthers) {
			if (ImGui::ColorEdit4("Others", rgbaOthers, ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex)) {
		...
		if (m_isEnabledSelf) {
			if (ImGui::ColorEdit4("Self", rgbaSelf, ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex)) {
