        ...
        if (ImGui::CollapsingHeader("Equipment Override")) {
            ...
            for (auto& overrideInfo : m_equipmentOverrides) {
                ...
                if (ImGui::TreeNode(&overrideInfo, "%s", overrideInfo.name.c_str())) {
                    ...
                    ImGui::ColorEdit4("Color 1", overrideInfo.color1.data(), ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex);
                    ImGui::ColorEdit4("Color 2", overrideInfo.color2.data(), ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex);
                    ImGui::ColorEdit4("Color 3", overrideInfo.color3.data(), ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex);
                    ImGui::ColorEdit4("Color 4", overrideInfo.color4.data(), ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex);
                    ImGui::ColorEdit4("Color 5", overrideInfo.color5.data(), ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex);
                    ImGui::ColorEdit4("Color 6", overrideInfo.color6.data(), ImGuiColorEditFlags_::ImGuiColorEditFlags_DisplayHex);
